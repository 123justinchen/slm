...
%             handle.transformShiftX = -5;
    ...
    focal_length_mm = focal_length_mm +3;
end
for f2=1:10
    f2 
    for u=0:5
        u
        steering_angle_x_deg = p - u*l;
        steering_angle_y_deg = p - u*l;
...
%             handle.transformShiftX = -5;
    ...
    focal_length_mm = focal_length_mm +5;
end
...
%           steering_angle_y_deg = p ;
        steering_angle_x_deg = p + u*0.005;
        steering_angle_y_deg = p + u*0.005;
...
% for f3=1:20
%     f3 
%     v = (focal_length_mm - 210)/100 ;
%     
%     for u=0:0.01:0.1*v
%         v
%         steering_angle_x_deg = p+u;
%         steering_angle_y_deg = p+u;
% 
%         for t=0:0.01:2.01*pi
%             steering_angle_x_deg1 = 0 + steering_angle_x_deg*cos(t);
%             steering_angle_y_deg1 = 0 + steering_angle_y_deg*sin(t);

...
%
%
% Calculates an axicon with speed-optimized code and shows it on the SLM.
...
% Calculate the phase values of an axicon in a pixel-wise matrix using matrix 
...
phaseData = single(phaseModulation) * sqrt(ones(dataHeight, 1, 'single')*x2 + y2*ones(1, dataWidth, 'single')) / single(innerRadius);
